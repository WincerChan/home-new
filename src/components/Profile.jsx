function UserProfile(props) {
    ...
    return (
        <div class='w-full md:w-[36rem] mx-auto my-12 2xl:my-20 flex-grow'>
            <div className='flex flex-col-reverse mx-4 md:flex-row text-title-dark justify-between'>
                <div>
                    <h1 className='leading-relaxed text-3xl my-2 md:text-4xl'>{config.name.base} <span className='font-sans md:text-xl'>{config.name.note}</span></h1>
