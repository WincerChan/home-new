...
const Footprint = (props) => {
    ...
    return (
        <>
            <h2 className=" text-heading-dark 2xl:text-3xl text-2xl mb-3 2xl:mb-6 mt-1 2xl:mt-2 leading-loose">Footprint</h2>
            <div className="grid sm:gap-6 gap-4 sm:grid-cols-3 leading-relaxed text-heading-dark 2xl:mb-12 xl:mb-8 mb-6">
